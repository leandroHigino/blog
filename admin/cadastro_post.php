                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-user"
                                            id="titulo" name="titulo" aria-describedby="emailHelp"
                                            placeholder="Título" oninput="generateSlug()">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-user"
                                            id="slug" name="slug" aria-describedby="emailHelp"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                        ...
                                        <textarea class="form-control form-control-user"
                                            id="conteudo" name="conteudo" row="5"></textarea>
                                    </div>
                                </div>
                                </div>
                            <div class="row">
